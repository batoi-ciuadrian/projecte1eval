      ...
      <!-- Clients Feedback -->
        <div class="row feedback text-center">
           ...
           <div class="col-xs-12 col-sm-3">
             ...
             <h5>MISS BELLA</h5>
             <q><?php if(count($mensajesAleatorios) > 0): echo $mensajesAleatorios[0]->getMensaje(); endif;?></q>
           </div>
           <div class="col-xs-12 col-sm-3">
             <img class="img-responsive" src="images/clients/client2.jpg" alt="client's picture">
             <h5>DON PENO</h5>
             <q><?php if(count($mensajesAleatorios) > 1): echo $mensajesAleatorios[1]->getMensaje(); endif;?></q>
           </div>
           <div class="col-xs-12 col-sm-3">
             <img class="img-responsive" src="images/clients/client3.jpg" alt="client's picture">
             <h5>SWEETY</h5>
             <q><?php if(count($mensajesAleatorios) > 2): echo $mensajesAleatorios[2]->getMensaje(); endif;?></q>
           </div>
           <div class="col-xs-12 col-sm-3">
             <img class="img-responsive" src="images/clients/client4.jpg" alt="client's picture">
             <h5>LADY</h5>
             <q><?php if(count($mensajesAleatorios) > 3): echo $mensajesAleatorios[3]->getMensaje(); endif;?></q>
           </div>
        </div>
