<div id="<?php echo $categoria; ?>" class="tab-pane <?php if ($activa == TRUE) {echo 'active';}?>" >

<div class="row popup-gallery">
    <?php foreach ($array as $imagen) { ?>
                ...
                <div class="behind">
                    <div class="head text-center">
                        <ul class="list-inline">
                            <li>
                                <a class="gallery" href='<?php $imagen->getUrlGallery().$imagen->getNombre(); ?>' alt='<?php echo $imagen->getDescripcion(); ?>' data-toggle="tooltip" data-original-title="Quick View">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </li>
                            <li>
